...
- **Pre-commit:** `wsl bash -c 'cd /mnt/c/.../sinapse-ai && ~/.local/bin/coderabbit --prompt-only -t uncommitted'`
- **Pre-PR:** `wsl bash -c 'cd /mnt/c/.../sinapse-ai && ~/.local/bin/coderabbit --prompt-only --base main'`
