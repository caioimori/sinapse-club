...
1. `.sinapse-ai/development/checklists/{name}.md`
2. `.sinapse-ai/development/checklists/{name}`
...
|-----------|---------|---------|
| `story-dod-checklist.md` | @developer | Definition of Done for stories |
| `self-critique-checklist.md` | @developer | Self-review at implementation checkpoints |
