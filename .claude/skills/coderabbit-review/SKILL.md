...
```bash
wsl bash -c 'cd /mnt/c/Users/AllFluence-User/Workspaces/SINAPSE/SinapseAI/sinapse-ai && ~/.local/bin/coderabbit {flags}'
```
...
|-------|---------------|-----------------|---------|
| @developer | 2 | CRITICAL only | Pre-commit (story completion) |
| @quality-gate | 3 | CRITICAL + HIGH | Story review start |
