...
```bash
node -e "const {runDiagnostics}=require('./.sinapse-ai/core/synapse/diagnostics/synapse-diagnostics');console.log(runDiagnostics(process.cwd()))"
```
...
- **SYNAPSE diagnostics**: `.sinapse-ai/core/synapse/diagnostics/synapse-diagnostics.js`
