...
The bracket system is implemented in `.sinapse-ai/core/synapse/context/context-tracker.js`.
...
The output formatter (`.sinapse-ai/core/synapse/output/formatter.js`) enforces token budgets:
