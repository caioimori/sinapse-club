...
SYNAPSE processes rules through an 8-layer pipeline executed sequentially on every prompt. Each layer has a specific purpose, trigger condition, and priority level. The engine orchestrator (`.sinapse-ai/core/synapse/engine.js`) chains all layers and the output formatter produces the final `<synapse-rules>` XML block.
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l1-global.js` |
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l2-agent.js` |

**Agents covered:** dev, qa, architect, pm, po, sm, devops, analyst, data-engineer, ux (ux-design-expert), sinapse-orqx, squad-creator.
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l3-workflow.js` |
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l4-task.js` |
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l5-squad.js` |
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l6-keyword.js` |
...
| **Implementation** | `.sinapse-ai/core/synapse/layers/l7-star-command.js` |
...
| File | Purpose |
|------|---------|
| `.sinapse-ai/core/synapse/engine.js` | SynapseEngine orchestrator |
| `.sinapse-ai/core/synapse/layers/l0-constitution.js` | L0 processor |
| `.sinapse-ai/core/synapse/layers/l1-global.js` | L1 processor |
| `.sinapse-ai/core/synapse/layers/l2-agent.js` | L2 processor |
| `.sinapse-ai/core/synapse/layers/l3-workflow.js` | L3 processor |
| `.sinapse-ai/core/synapse/layers/l4-task.js` | L4 processor |
| `.sinapse-ai/core/synapse/layers/l5-squad.js` | L5 processor |
| `.sinapse-ai/core/synapse/layers/l6-keyword.js` | L6 processor |
| `.sinapse-ai/core/synapse/layers/l7-star-command.js` | L7 processor |
| `.sinapse-ai/core/synapse/layers/layer-processor.js` | Abstract base class |
| `.sinapse-ai/core/synapse/output/formatter.js` | XML formatter + token budget |
