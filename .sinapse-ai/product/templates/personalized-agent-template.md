...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .sinapse-ai/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .sinapse-ai/tasks/create-doc.md
...
- Refer to archetype vocabulary lists in `.sinapse-ai/data/archetype-vocabulary.yaml`
