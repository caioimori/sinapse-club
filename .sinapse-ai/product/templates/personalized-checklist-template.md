...
2. All tests pass
3. Execute `.sinapse-ai/product/checklists/story-dod-checklist.md`
...
node .sinapse-ai/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .sinapse-ai/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.sinapse-ai/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.sinapse-ai/agents/{agent-id}.md`
