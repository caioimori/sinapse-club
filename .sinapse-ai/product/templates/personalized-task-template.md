...
**Tasks:**
- `.sinapse-ai/tasks/{dependency1}.md`
- `.sinapse-ai/tasks/{dependency2}.md`

**Templates:**
- `.sinapse-ai/product/templates/{template1}.yaml`

**Checklists:**
- `.sinapse-ai/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.sinapse-ai/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.sinapse-ai/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
