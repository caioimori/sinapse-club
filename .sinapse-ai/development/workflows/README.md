...
This directory contains workflow definitions for the SINAPSE framework. Workflows define multi-step processes that can be executed by SINAPSE agents.
...
The `setup-environment` workflow helps developers configure their IDE for optimal SINAPSE development experience.

### Features
- Backs up existing IDE configurations
- Applies SINAPSE-specific development rules
...
4. **Rule Application** - Copies SINAPSE-specific rules to appropriate locations
