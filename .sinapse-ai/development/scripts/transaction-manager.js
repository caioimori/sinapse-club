/**
 * Transaction Manager for SINAPSE-FULLSTACK
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'sinapse-ai', 'transactions');
    this.backupPath = path.join(this.rootPath, 'sinapse-ai', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'sinapse-ai', 'team-manifest.yaml');
