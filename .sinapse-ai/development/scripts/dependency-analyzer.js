/**
 * Dependency Analyzer for SINAPSE-FULLSTACK
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'sinapse-ai', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'sinapse-ai', 'agents'),
      tasks: path.join(this.rootPath, 'sinapse-ai', 'tasks'),
      workflows: path.join(this.rootPath, 'sinapse-ai', 'workflows')
    };
