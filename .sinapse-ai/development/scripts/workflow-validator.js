 ...
 * Workflow Validator
 *
 * Validates workflow YAML files against SINAPSE workflow conventions:
 * 1. YAML syntax
...
class WorkflowValidator {
  ...
  constructor(options = {}) {
    ...
    this.agentsPath = options.agentsPath || path.join(process.cwd(), '.sinapse-ai', 'development', 'agents');
