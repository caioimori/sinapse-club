...
Utilities for the squad-creator agent to manage squads in SINAPSE projects.
...
```javascript
const { SquadLoader } = require('./.sinapse-ai/development/scripts/squad');
...
```javascript
const { SquadLoader, SquadLoaderError } = require('./.sinapse-ai/development/scripts/squad');
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".sinapse-ai/development/scripts/squad/*.js"
```
