/**
 * Story Index Generator for SINAPSE Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by SINAPSE Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .sinapse-ai/scripts/story-index-generator.js docs/stories`*\n';
