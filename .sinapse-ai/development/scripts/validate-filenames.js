 ...
 *
 * Usage:
 *   node .sinapse-ai/utils/validate-filenames.js
 *   node .sinapse-ai/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 SINAPSE Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .sinapse-ai/utils/validate-filenames.js --fix\n');
