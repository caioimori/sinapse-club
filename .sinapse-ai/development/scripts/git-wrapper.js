...
/**
 * Git operations wrapper for SINAPSE framework modifications
 */
class GitWrapper {
  constructor(options = {}) {
  ...
  async commit(message, options = {}) {
    const {
      author = 'sinapse-developer <sinapse-developer@sinapse-fullstack.local>',
      signoff = true
    } = options;
  ...
  async commitModification(files, message, metadata = {}) {
    ...
    fullMessage += '\n\nGenerated by: sinapse-developer meta-agent';
