/**
 * Apply Inline Greeting Logic to All 11 SINAPSE Agents
...
const CLAUDE_AGENTS_DIR = path.join(__dirname, '..', '..', '.claude', 'commands', 'SINAPSE', 'agents');
...
function main() {
  ...
  if (results.updated > 0) {
    ...
    console.log('🔄 Files synchronized to .claude/commands/SINAPSE/agents/');
  }
}
