/**
 * Backlog Manager for SINAPSE Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by SINAPSE Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .sinapse-ai/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
