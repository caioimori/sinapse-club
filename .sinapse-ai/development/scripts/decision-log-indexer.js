 ...
 * @see .sinapse-ai/scripts/decision-recorder.js
 */
...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.sinapse-ai/core-config.yaml', 'utf8');
...
- [Core Configuration](.sinapse-ai/core-config.yaml)
...
*To manually rebuild the index, run: node .sinapse-ai/scripts/decision-log-indexer.js rebuild*
`;
