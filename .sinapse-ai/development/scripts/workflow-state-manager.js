 ...
 * New code should use: .sinapse-ai/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .sinapse/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.sinapse');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.sinapse-ai', 'development', 'agents');
