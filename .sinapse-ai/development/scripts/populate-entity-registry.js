...
const SCAN_CONFIG = [
  ...
  { category: 'utils', basePath: '.sinapse-ai/core/utils', glob: '**/*.js', type: 'util' },
  { category: 'tools', basePath: '.sinapse-ai/development/tools', glob: '**/*.{md,js,sh}', type: 'tool' },
  { category: 'infra-scripts', basePath: '.sinapse-ai/infrastructure/scripts', glob: '**/*.js', type: 'script' },
  { category: 'infra-tools', basePath: '.sinapse-ai/infrastructure/tools', glob: '**/*.{yaml,yml,md}', type: 'tool' },
  { category: 'product-checklists', basePath: '.sinapse-ai/product/checklists', glob: '**/*.md', type: 'checklist' },
...
function populate(options = {}) {
  const verbose = options.verbose || process.argv.includes('--verbose') || process.env.SINAPSE_DEBUG === 'true';
