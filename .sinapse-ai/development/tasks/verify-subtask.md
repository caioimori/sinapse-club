...
autoClaude:
  ...
  verification:
    type: script
    script: .sinapse-ai/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .sinapse/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .sinapse-ai/infrastructure/scripts/subtask-verifier.js {subtaskId} \
