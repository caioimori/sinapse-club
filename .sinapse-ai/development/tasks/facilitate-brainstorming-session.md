...
- **topic**: `string`
  ...
  - **Example**: "How can we improve user onboarding for SINAPSE?"
...
```bash
sinapse activate Maestro
sinapse brainstorm "How can we improve SINAPSE user onboarding for non-technical users?"
```
...
```bash
sinapse brainstorm "How to reduce API latency in database queries?" \
...
```bash
sinapse brainstorm "What should be our open-source expansion strategy for Q1 2026?" \
