...
- Load `.sinapse-ai/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `sinapse-ai/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `sinapse-ai/templates/story-tmpl.yaml` and extract all section headings from the template
