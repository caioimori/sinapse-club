...
Each component type uses a template from `.sinapse-ai/development/templates/squad/`:
...
- **Scripts:**
  - `.sinapse-ai/development/scripts/squad/squad-loader.js`
  - `.sinapse-ai/development/scripts/squad/squad-extender.js`
  - `.sinapse-ai/development/scripts/squad/squad-validator.js`

- **Templates:**
  - `.sinapse-ai/development/templates/squad/agent-template.md`
  - `.sinapse-ai/development/templates/squad/task-template.md`
  - `.sinapse-ai/development/templates/squad/workflow-template.md`
  - `.sinapse-ai/development/templates/squad/checklist-template.md`
  - `.sinapse-ai/development/templates/squad/template-template.md`
  - `.sinapse-ai/development/templates/squad/tool-template.js`
  - `.sinapse-ai/development/templates/squad/script-template.js`
  - `.sinapse-ai/development/templates/squad/data-template.yaml`
