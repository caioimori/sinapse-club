...
- **Tool:** workflow-validator
  ...
  - **Source:** .sinapse-ai/development/scripts/workflow-validator.js
...
- **Script:** workflow-validator.js
  ...
  - **Language:** JavaScript
  - **Location:** .sinapse-ai/development/scripts/workflow-validator.js
...
To validate workflow YAML files against SINAPSE conventions, checking structure, agent references, artifact flow, and logical consistency. Supports validating a single workflow or all workflows in a given context (core or squad).

## Prerequisites

- WorkflowValidator class available at `.sinapse-ai/development/scripts/workflow-validator.js`
...
- Resolve based on target_context:
  - `core` → `.sinapse-ai/development/workflows/{workflow_name}.yaml`
...
- Scan directory based on target_context:
  - `core` → all `.yaml` files in `.sinapse-ai/development/workflows/`
