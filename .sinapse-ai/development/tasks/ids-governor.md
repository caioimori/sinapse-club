...
```bash
node bin/sinapse-ids.js ids:check "your intent" --type task
node bin/sinapse-ids.js ids:impact create-doc
node bin/sinapse-ids.js ids:stats --json
node bin/sinapse-ids.js ids:register path/to/file.md
```
...
- `.sinapse-ai/core/ids/framework-governor.js` — FrameworkGovernor class
- `.sinapse-ai/core/ids/registry-loader.js` — RegistryLoader
- `.sinapse-ai/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.sinapse-ai/core/ids/registry-updater.js` — RegistryUpdater
- `.sinapse-ai/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
