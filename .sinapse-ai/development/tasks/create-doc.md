...
# User selects from available templates in .sinapse-ai/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .sinapse-ai/product/templates or ask the user to provide another.
...
const { getCodebaseOverview, getDependencyGraph } = require('.sinapse-ai/core/code-intel/helpers/planning-helper');
