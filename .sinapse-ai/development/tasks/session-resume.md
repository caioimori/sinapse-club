...
```javascript
const { loadSessionState } = require('.sinapse-ai/core/orchestration');
...
```javascript
const { SessionState } = require('.sinapse-ai/core/orchestration');
...
```javascript
const { ResumeOption } = require('.sinapse-ai/core/orchestration');
