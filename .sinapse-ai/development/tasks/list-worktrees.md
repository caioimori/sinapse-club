...
Lists all SINAPSE-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

**Features:**

- Shows all active worktrees managed by SINAPSE
...
**Action:** Get all SINAPSE-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.sinapse/worktrees/STORY-42",
...
No SINAPSE-managed worktrees found.
...
**Resolution:** Check SINAPSE installation.
...
- `.sinapse-ai/infrastructure/scripts/worktree-manager.js`
