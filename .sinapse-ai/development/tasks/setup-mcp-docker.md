...
Configure Docker MCP Toolkit as the primary MCP infrastructure for SINAPSE, using **HTTP transport** instead of stdio to avoid timeout issues during gateway initialization.
...
Configure Docker MCP Toolkit as the primary MCP infrastructure for SINAPSE, replacing 1MCP with the containerized gateway approach. This enables:
