...
# Deprecate Component - SINAPSE Developer Task
...
*deprecate-component util old-logger --replacement @sinapse/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 SINAPSE Component Deprecation'));
