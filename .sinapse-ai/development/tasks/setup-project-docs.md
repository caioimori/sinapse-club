...
- field: core_config
  type: file
  destination: .sinapse-ai/core-config.yaml
  persisted: true
...
pre-conditions:
  ...
  - [ ] Documentation Integrity module is available
    ...
    blocker: true
    validation: |
      Verify .sinapse-ai/infrastructure/scripts/documentation-integrity/index.js exists
...
post-conditions:
  ...
  - [ ] core-config.yaml created with valid deployment section
    ...
    blocker: true
    validation: |
      Verify .sinapse-ai/core-config.yaml exists and has deployment configuration
...
acceptance-criteria:
  ...
  - [ ] .gitignore properly configured for project
    ...
    blocker: true
    validation: |
      Assert .gitignore includes SINAPSE ignores and tech stack ignores
...
- **Tool:** documentation-integrity
  ...
  - **Source:** .sinapse-ai/infrastructure/scripts/documentation-integrity/index.js

- **Tool:** deployment-config-loader
  - **Purpose:** Load and validate deployment configuration
  - **Source:** .sinapse-ai/infrastructure/scripts/documentation-integrity/deployment-config-loader.js
...
- **Script:** mode-detector.js
  ...
  - **Language:** JavaScript
  - **Location:** .sinapse-ai/infrastructure/scripts/documentation-integrity/mode-detector.js

- **Script:** doc-generator.js
  - **Purpose:** Generate project documentation from templates
  - **Language:** JavaScript
  - **Location:** .sinapse-ai/infrastructure/scripts/documentation-integrity/doc-generator.js

- **Script:** config-generator.js
  - **Purpose:** Generate core-config.yaml
  - **Language:** JavaScript
  - **Location:** .sinapse-ai/infrastructure/scripts/documentation-integrity/config-generator.js

- **Script:** gitignore-generator.js
  - **Purpose:** Generate or merge .gitignore
  - **Language:** JavaScript
  - **Location:** .sinapse-ai/infrastructure/scripts/documentation-integrity/gitignore-generator.js
...
```javascript
const { detectInstallationMode, collectMarkers } = require('./.sinapse-ai/infrastructure/scripts/documentation-integrity');
...
|------|-------------|---------|
| `framework-dev` | Contributing to sinapse-ai itself | Skip project setup, use existing config |
...
```javascript
const { buildDocContext, generateDocs } = require('./.sinapse-ai/infrastructure/scripts/documentation-integrity');
...
```javascript
const { buildConfigContext, generateConfig, DeploymentWorkflow, DeploymentPlatform } = require('./.sinapse-ai/infrastructure/scripts/documentation-integrity');
...
```javascript
const { generateGitignoreFile, hasSinapseIntegration } = require('./.sinapse-ai/infrastructure/scripts/documentation-integrity');
...
```javascript
const { loadDeploymentConfig, validateDeploymentConfig } = require('./.sinapse-ai/infrastructure/scripts/documentation-integrity');
