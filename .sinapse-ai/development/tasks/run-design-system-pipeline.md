...
- **Tool:** build-component
  ...
  - **Source:** .sinapse-ai/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .sinapse-ai/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .sinapse-ai/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx sinapse-ai task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx sinapse-ai task run-design-system-pipeline",
    "ds:pipeline:ci": "npx sinapse-ai task run-design-system-pipeline --mode=yolo"
  }
}
```
