...
#### For Code PRs (packages/, .sinapse-ai/, bin/)
...
gh pr diff {pr_number} -- 'packages/' '.sinapse-ai/' 'bin/' | grep -E "(shell:\s*true|execSync\(|\.exec\(|eval\(|Function\()"
