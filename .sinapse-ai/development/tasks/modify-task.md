...
- Target task must exist in `sinapse-ai/tasks/`
...
- Load target task from `sinapse-ai/tasks/{task-name}.md`
- Create timestamped backup: `sinapse-ai/tasks/.backups/{task-name}.md.{timestamp}`
