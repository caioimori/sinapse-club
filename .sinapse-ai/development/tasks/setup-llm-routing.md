...
- Tool Definition: `.sinapse-ai/infrastructure/tools/cli/llm-routing.yaml`
- Install Script: `.sinapse-ai/infrastructure/scripts/llm-routing/install-llm-routing.js`
