...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .sinapse-ai/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.sinapse-ai/workflow-intelligence/learning');
...
Storage file: .sinapse-ai/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .sinapse-ai/data/learned-patterns.yaml');
}
```
