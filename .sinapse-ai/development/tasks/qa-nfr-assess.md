...
required:
  ...
  - story_path: `sinapse-ai/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `sinapse-ai/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `sinapse-ai/core-config.yaml` for the `technicalPreferences`
