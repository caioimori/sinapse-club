...
**Purpose**: Analyze changes, recommend version bumps, and manage semantic versioning for ANY repository using SINAPSE.
...
if (!context) {
  throw new Error('Unable to detect repository context. Run "sinapse init" first.');
}
