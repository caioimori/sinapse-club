...
3. `.sinapse-ai/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".sinapse-ai/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".sinapse-ai/product/templates/tmpl-smoke-test.sql"
else
