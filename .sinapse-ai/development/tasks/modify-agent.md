...
- Target agent must exist in `sinapse-ai/agents/`
...
- Load target agent from `sinapse-ai/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `sinapse-ai/agents/.backups/{agent-name}.md.{timestamp}`
