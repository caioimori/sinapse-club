...
Systematic triage of GitHub issues for the sinapse-ai repository. This task guides @devops through the process of reviewing, classifying, and labeling open issues.
...
```bash
node .sinapse-ai/development/scripts/issue-triage.js --list
node .sinapse-ai/development/scripts/issue-triage.js --apply {number} --type bug --priority P2 --area installer
```
...
```bash
node .sinapse-ai/development/scripts/issue-triage.js --report
```
