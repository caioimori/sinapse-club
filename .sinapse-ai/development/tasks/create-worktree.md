...
pre-conditions:
  ...
  - [ ] WorktreeManager is available
    tipo: pre-condition
    blocker: true
    validação: Script exists at .sinapse-ai/infrastructure/scripts/worktree-manager.js
    error_message: "WorktreeManager not found. Ensure SINAPSE is properly installed."
...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .sinapse/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .sinapse-ai/infrastructure/scripts/worktree-manager.js
...
```javascript
const WorktreeManager = require('./.sinapse-ai/infrastructure/scripts/worktree-manager.js');
...
⚠️  Worktree for '{storyId}' already exists.
    Path: .sinapse/worktrees/{storyId}
...
- Directory: `.sinapse/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .sinapse/worktrees/{storyId}  - Navigate to worktree
...
- `.sinapse/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .sinapse/worktrees/{storyId}
...
- `.sinapse-ai/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.sinapse-ai/infrastructure/scripts/worktree-manager.js`
