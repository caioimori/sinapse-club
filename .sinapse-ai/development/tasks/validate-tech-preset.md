...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .sinapse-ai/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .sinapse-ai/data/tech-presets/{name}.md
...
- Preset: .sinapse-ai/data/tech-presets/{name}.md
```
