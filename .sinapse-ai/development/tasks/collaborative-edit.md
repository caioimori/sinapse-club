...
# Collaborative Edit - SINAPSE Developer Task
...
*collaborative-edit start --component sinapse-ai/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.sinapse', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 SINAPSE Collaborative Editing'));
