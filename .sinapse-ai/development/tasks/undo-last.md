...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the sinapse-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /sinapse-ai/agents/data-analyst.md
  - Updated: /sinapse-ai/team-manifest.yaml
  - Created: /sinapse-ai/tasks/analyze-data.md
```
