...
Downloads public squads from the sinapse-squads GitHub repository to use in your project.
...
Available Squads (from sinapse-squads):
...
```
1. Fetch registry.json from sinapse-squads
...
The registry.json in sinapse-squads contains:
...
- `.sinapse-ai/development/scripts/squad/squad-downloader.js`
