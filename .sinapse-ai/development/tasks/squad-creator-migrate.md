...
Migrates legacy squad formats to SINAPSE 2.1 standard.
...
| Missing `sinapse.type` | Field not present | Add `sinapse.type: squad` |
| Missing `sinapse.minVersion` | Field not present | Add `sinapse.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: sinapse.type
  ❌ [ERROR] Missing required field: sinapse.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: sinapse.type = "squad"
  4. Add field: sinapse.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: sinapse.type = "squad" [success]
    ✅ Add field: sinapse.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: sinapse.type = "squad" [dry-run]
    🔍 Add field: sinapse.minVersion = "2.1.0" [dry-run]
...
```javascript
const { SquadMigrator } = require('./.sinapse-ai/development/scripts/squad');
const { SquadValidator } = require('./.sinapse-ai/development/scripts/squad');
