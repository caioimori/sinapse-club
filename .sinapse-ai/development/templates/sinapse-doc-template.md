# SINAPSE Documentation Template
...
This document provides the standard template structure for SINAPSE documentation. All documentation in the SINAPSE framework should follow this template to ensure consistency and ease of navigation.
...
_Last Updated: {{DATE}} | SINAPSE Framework Team_
```
...
Brief description of what this document covers and its purpose within the SINAPSE framework.
...
**Version:** 1.0.0
**Last Updated:** 2026-01-28
**Audience:** Developers extending SINAPSE

---

## Overview

This guide explains how to create custom agents for the SINAPSE framework.
...
Create a new file in `.sinapse-ai/development/agents/`:
...
- [SINAPSE Framework Documentation](/docs/README.md)
