#!/usr/bin/env node
// =============================================================================
// SINAPSE Capability Detection Module
// =============================================================================
...
//
// Usage:
//   node .sinapse-ai/data/capability-detection.js
//
// Output:
//   .sinapse/runtime-capabilities.json
// =============================================================================
...
const OUTPUT_PATH = path.join(PROJECT_ROOT, '.sinapse', 'runtime-capabilities.json');
...
function loadToolRegistry() {
  const registryPath = path.join(PROJECT_ROOT, '.sinapse-ai', 'data', 'tool-registry.yaml');
  try {
