...
//
// Usage:
//   node .sinapse-ai/data/mcp-discipline.js --apply     # Disable non-essential
//   node .sinapse-ai/data/mcp-discipline.js --restore   # Re-enable all
//   node .sinapse-ai/data/mcp-discipline.js --status    # Show current state
//   node .sinapse-ai/data/mcp-discipline.js --enable <server>  # Re-enable specific
// =============================================================================
...
const BACKUP_PATH = path.join(PROJECT_ROOT, '.sinapse', 'mcp-backup.json');
const CAPABILITIES_PATH = path.join(PROJECT_ROOT, '.sinapse', 'runtime-capabilities.json');
