 ...
 *
 * Mode-aware project configuration system for SINAPSE.
...
module.exports = {
  ...
  isSinapseCoreRepository: modeDetector.isSinapseCoreRepository,
  ...
  hasSinapseIntegration: gitignoreGenerator.hasSinapseIntegration,
