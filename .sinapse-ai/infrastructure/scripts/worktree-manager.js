 ...
 * @property {string} [worktreeDir='.sinapse/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.sinapse/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.sinapse/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.sinapse/logs/merges';
    this.gitPath = 'git';
  }
