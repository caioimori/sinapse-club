 ...
 * - AC2: Generates `.sinapse/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.sinapse/gotchas.json',
  ...
  // Schema version
  schemaVersion: 'sinapse-gotchas-v1',
};
...
*Generated by SINAPSE Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - SINAPSE Memory Layer (Story 7.4)
