...
const CONFIG = {
  ...
  // Template path
  templatePath: '.sinapse-ai/product/templates/qa-report-tmpl.md',
...
*Generated by SINAPSE QA Report Generator v1.0*
`;
  }
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
QA Report Generator - SINAPSE QA Evolution (Story 6.2)
