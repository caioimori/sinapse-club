...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.sinapse', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .sinapse-ai)
