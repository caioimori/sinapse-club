...
/**
 * SINAPSE Agent Migration Script (V2 → V3)
...
// Paths
const AGENTS_DIR = '.sinapse-ai/development/agents';
const BACKUP_DIR = '.sinapse/migration-backup';
const SCHEMAS_DIR = '.sinapse-ai/schemas';
...
function formatListOutput(agents) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  SINAPSE Agents - Migration Status');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('');
