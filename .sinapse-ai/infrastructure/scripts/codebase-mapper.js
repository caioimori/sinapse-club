 ...
 * - AC3: Output: `.sinapse/codebase-map.json`
...
const CONFIG = {
  // AC3: Output path
  outputPath: '.sinapse/codebase-map.json',
  // Schema version
  schemaVersion: '1.0',
  // Default max depth
  defaultMaxDepth: 5,
...
async function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(`
Codebase Mapper - SINAPSE Memory Layer (Story 7.2)
...
Commands:
  ...
  save            Save to .sinapse/codebase-map.json
