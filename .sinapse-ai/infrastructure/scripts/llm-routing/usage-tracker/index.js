 ...
 * @location .sinapse-ai/infrastructure/scripts/llm-routing/usage-tracker/
 */
...
const DATA_DIR = path.join(os.homedir(), '.sinapse', 'usage-tracking');
...
║  Data File:    ~/.sinapse/usage-tracking/deepseek-usage.json  ║
╠════════════════════════════════════════════════════════════╣
║  Endpoints:                                                ║
║    /health     - Health check                              ║
