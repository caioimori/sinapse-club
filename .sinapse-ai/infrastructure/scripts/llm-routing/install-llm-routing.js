 ...
 *
 * @module llm-routing
 * @location .sinapse-ai/infrastructure/scripts/llm-routing/
 */
...
function getInstallationSummary(result) {
  ...
  if (result.success) {
    ...
    summary.push('');
    summary.push('Usage data saved to: ~/.sinapse/usage-tracking/deepseek-usage.json');
    summary.push('');
  } else {
    summary.push('');
