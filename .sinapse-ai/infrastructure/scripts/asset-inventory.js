...
/**
 * SINAPSE Asset Inventory Generator
 * Story 2.1: Creates comprehensive inventory of all SINAPSE assets
 *
 * Usage:
...
const ASSET_PATHS = {
  ...
  templates: '.sinapse-ai/product/templates',
  checklists: '.sinapse-ai/product/checklists',
  scripts: '.sinapse-ai/infrastructure/scripts',
  schemas: '.sinapse-ai/schemas',
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  SINAPSE Asset Inventory');
...
Options:
  ...
  // Find project root (look for .sinapse-ai directory)
