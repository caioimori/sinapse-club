...
Multi-provider AI integration for SINAPSE. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.sinapse-ai-config.yaml` in project root:
