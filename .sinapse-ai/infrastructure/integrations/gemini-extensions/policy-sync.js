...
class PolicySync {
  ...
  /**
   * Get SINAPSE permission policies
   */
  async getSINAPSEPolicies() {
    const policiesPath = path.join(this.projectDir, '.sinapse', 'policies.json');
  ...
  async exportToGemini() {
    const policies = await this.getSINAPSEPolicies();
