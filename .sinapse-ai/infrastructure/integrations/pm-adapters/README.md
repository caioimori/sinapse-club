...
Project Management tool adapters for SINAPSE. Enables story synchronization with various PM tools.
...
PM tool is configured via `.sinapse-pm-config.yaml` in the project root:
