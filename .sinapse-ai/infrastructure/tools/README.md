# SINAPSE Tools - Integrations Directory

This directory contains tool integration definitions for SINAPSE agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
...
ls -la .sinapse-ai/tools/cli/
ls -la .sinapse-ai/tools/local/
ls -la .sinapse-ai/tools/mcp/

# Test tool resolver
node .sinapse-ai/infrastructure/scripts/tool-resolver.js
```
