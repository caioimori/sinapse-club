...
/**
 * Test template system for SINAPSE automated test generation
 * Provides reusable templates for generating different types of tests
 */
class TestTemplateSystem {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.templatesDir = path.join(this.rootPath, 'sinapse-ai', 'templates', 'tests');
  ...
  async generateTestContent(component, testFile, config) {
    ...
    const templateData = {
      ...
      metadata: {
        ...
        generator: 'SINAPSE Test Template System',
        version: '1.0.0',
      },
    };
    ...
    return {
      agent: {
        ...
        setup: {
          ...
          beforeEach: [
            "agentPath = path.join(__dirname, '../../../sinapse-ai/agents/{{component.name}}.md');",
      ...
      task: {
        ...
        setup: {
          ...
          beforeEach: [
            "taskPath = path.join(__dirname, '../../../sinapse-ai/tasks/{{component.name}}.md');",
      ...
      workflow: {
        ...
        setup: {
          ...
          beforeEach: [
            "workflowPath = path.join(__dirname, '../../../sinapse-ai/workflows/{{component.name}}.yaml');",
      ...
      util: {
        ...
        setup: {
          ...
          beforeEach: [
            "UtilClass = require('../../../sinapse-ai/scripts/{{component.name}}');",
...
afterAll(async () => {
  ...
  renderMetadata(metadata, data) {
    return `
// Generated by SINAPSE Test Template System
