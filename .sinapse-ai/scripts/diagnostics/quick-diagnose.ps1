# SINAPSE-Core Quick Diagnostic - Run this in PowerShell
# Usage: Copy and paste this entire script into PowerShell on the target machine

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "   SINAPSE-Core Quick Diagnostic" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$registryTest = & npm view sinapse-ai version 2>$null
if ($registryTest) {
    Write-Host "  sinapse-ai v$registryTest available" -ForegroundColor Green
} else {
...
# Test npx sinapse-ai
Write-Host ""
Write-Host "Testing: npx sinapse-ai@latest --version" -ForegroundColor Yellow
Write-Host "(This may take a moment...)" -ForegroundColor Gray
try {
    $result = & npx sinapse-ai@latest --version 2>&1
