...
echo.
echo ========================================
echo    SINAPSE-Core Quick Diagnostic (CMD)
echo ========================================
echo.
...
echo.
echo Checking sinapse-ai availability on npm...
npm view sinapse-ai version 2>nul
if %errorlevel% neq 0 (
    echo   ERROR: Cannot access npm registry!
    echo   Check your internet/firewall settings
) else (
    echo   sinapse-ai: Available
)

echo.
echo ========================================
echo    Testing npx sinapse-ai@latest
echo ========================================
echo.
echo Running: npx sinapse-ai@latest --version
echo (This may take a moment on first run...)
echo.
npx sinapse-ai@latest --version
if %errorlevel% neq 0 (
    echo.
    echo   ERROR: npx sinapse-ai failed!
    echo.
    echo Common fixes:
