# SINAPSE Health Dashboard

Visual dashboard for the SINAPSE Health Check System. Displays real-time health status, domain scores, issues, and self-healing history.
...
- **Production**: Reads from `.sinapse/reports/health-check-latest.json`
...
- [Health Check Core Module](../../.sinapse-ai/core/health-check/)
- [JSON Reporter](../../.sinapse-ai/core/health-check/reporters/json.js)
