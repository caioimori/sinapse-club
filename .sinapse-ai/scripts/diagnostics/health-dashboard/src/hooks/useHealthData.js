...
const DEFAULT_REPORT_PATH = '../../.sinapse/reports/health-check-latest.json';
    ...
    autoFixed: [
      {
        ...
        backup: '.sinapse/backups/gitignore.1704380400',
        timestamp: new Date(Date.now() - 3600000).toISOString(),
      },
      {
        checkId: 'PC-001',
        action: 'recreated-config',
        backup: '.sinapse/backups/config.yaml.1704376800',
