...
> Schema definitions for SINAPSE agents and tasks with Auto-Claude capabilities.
...
- **V2 (Legacy)**: Current SINAPSE format without `autoClaude` section
...
- Migration Stories: `docs/stories/sinapse-ai-ade/epic-2-migration-v2-v3.md`
