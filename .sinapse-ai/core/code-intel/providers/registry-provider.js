 ...
 * Data source: .sinapse-ai/data/entity-registry.yaml (737+ entities, 14 categories).
 *
...
class RegistryProvider extends CodeIntelProvider {
  ...
  _resolveRegistryPath() {
    ...
    const defaultPath = path.join(projectRoot, '.sinapse-ai', 'data', 'entity-registry.yaml');
