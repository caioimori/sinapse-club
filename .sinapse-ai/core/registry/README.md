# SINAPSE Service Registry

The Service Registry is the central catalog of all workers, tasks, templates, scripts, and workflows in the SINAPSE framework. It enables service discovery, search, and reuse across the system.
...
The builder scans:
- `.sinapse-ai/development/tasks/**/*.md` → task
- `.sinapse-ai/product/templates/**/*.md` → template
- `.sinapse-ai/infrastructure/scripts/**/*.js` → script
- `.sinapse-ai/product/checklists/**/*.md` → checklist
- `.sinapse-ai/development/workflows/**/*.yaml` → workflow
- `.sinapse-ai/core/data/**/*` → data
...
- **Discovery CLI** (Story 2.7-2.9): `sinapse search`, `sinapse info`, `sinapse list`
...
*Generated by SINAPSE Framework v4.0.4*
