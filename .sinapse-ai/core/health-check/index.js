 ...
 *
 * Provides comprehensive health checking capabilities for SINAPSE projects.
 ...
 * The primary diagnostic interface is `sinapse doctor` (bin/sinapse.js → core/doctor/).
 * The agent-facing task `*health-check` now delegates to `sinapse doctor --json`
 ...
 *
 * @module sinapse-ai/health-check
 * @version 1.0.0
