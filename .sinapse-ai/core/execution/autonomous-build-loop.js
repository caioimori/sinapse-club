 ...
 * Inspired by Auto-Claude's Coder Agent but with SINAPSE extensibility.
 *
 * Features:
 * - AC1: Located in `.sinapse-ai/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Autonomous Build Loop')} - SINAPSE Coder Agent Loop (Story 8.1)
