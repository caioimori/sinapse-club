...
/**
 * Get global SINAPSE directory path
 * @returns {string} Path to ~/.sinapse/
 */
function getGlobalSinapseDir() {
  return path.join(getHomeDir(), '.sinapse');
}

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.sinapse/mcp/
 */
function getGlobalMcpDir() {
  return path.join(getGlobalSinapseDir(), 'mcp');
}

/**
 * Get global MCP config file path
 * @returns {string} Path to ~/.sinapse/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.sinapse/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.sinapse/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.sinapse/credentials/
 */
function getCredentialsDir() {
  return path.join(getGlobalSinapseDir(), 'credentials');
}
