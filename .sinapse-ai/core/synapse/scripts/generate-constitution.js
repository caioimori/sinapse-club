 ...
 *
 * Reads .sinapse-ai/constitution.md and generates .synapse/constitution
 * in KEY=VALUE format for the SYNAPSE Context Engine L0 layer.
 *
 * Usage: node .sinapse-ai/core/synapse/scripts/generate-constitution.js
 *
...
function generateConstitution(articles) {
  const lines = [
    ...
    '# Auto-generated from .sinapse-ai/constitution.md',
...
function main(options = {}) {
  ...
  const constitutionPath = options.constitutionPath || path.join(projectRoot, '.sinapse-ai', 'constitution.md');
