 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .sinapse-ai/core/memory/
 * - AC2: Persists in .sinapse/gotchas.json and .sinapse/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.sinapse/gotchas.json',
  gotchasMdPath: '.sinapse/gotchas.md',
  errorTrackingPath: '.sinapse/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'sinapse-gotchas-memory-v1',
};
...
> Auto-generated by SINAPSE Gotchas Memory
> Last updated: ${now}
...
*Generated by SINAPSE Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - SINAPSE Memory Layer (Story 9.4)
