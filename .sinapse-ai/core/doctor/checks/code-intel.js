 ...
 *
 * @module sinapse-ai/doctor/checks/code-intel
...
async function run(context) {
  const codeIntelDir = path.join(context.projectRoot, '.sinapse-ai', 'core', 'code-intel');
    ...
    if (!available) {
      ...
      if (fs.existsSync(registryPath)) {
        ...
        return {
          ...
          fixCommand: 'node .sinapse-ai/development/scripts/populate-entity-registry.js',
        };
      }
