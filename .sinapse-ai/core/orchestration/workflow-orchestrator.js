 ...
 * and executes the defined task following SINAPSE methodology.
 *
...
class WorkflowOrchestrator {
  ...
  _resolveConfidenceThreshold(explicitThreshold) {
    ...
    const envThreshold = Number(process.env.SINAPSE_DELIVERY_CONFIDENCE_THRESHOLD);
