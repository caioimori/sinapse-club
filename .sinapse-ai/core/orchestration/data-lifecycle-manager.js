 ...
 * - Session states older than 30 days (archived to .sinapse/archive/sessions/)
...
const ARCHIVE_DIR = '.sinapse/archive/sessions';
const SNAPSHOTS_DIR = '.sinapse/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .sinapse/archive/sessions/
   *
