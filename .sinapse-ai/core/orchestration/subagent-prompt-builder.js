...
class SubagentPromptBuilder {
  ...
  constructor(projectRoot) {
    ...
    this.sinapseCoreRoot = path.join(projectRoot, '.sinapse-ai');

    // Paths to SINAPSE components
    this.paths = {
      agents: path.join(this.sinapseCoreRoot, 'development', 'agents'),
      tasks: path.join(this.sinapseCoreRoot, 'development', 'tasks'),
      checklists: path.join(this.sinapseCoreRoot, 'product', 'checklists'),
      templates: path.join(this.sinapseCoreRoot, 'product', 'templates'),
    };
  }
