...
class WorkflowExecutor {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.sinapse-ai/development/workflows/development-cycle.yaml',
    );
    this.statePath = path.join(projectRoot, '.sinapse/workflow-state/');
    this.configPath = path.join(projectRoot, '.sinapse-ai/core-config.yaml');
