...
class DashboardEmitter {
  ...
  constructor() {
    ...
    this.fallbackPath = path.join(this.projectRoot, '.sinapse', 'dashboard', 'events.jsonl');
  ...
  async emit(type, data = {}) {
    ...
    const event = {
      ...
      sinapse_agent: this.currentAgent || undefined,
      sinapse_story_id: this.currentStoryId || undefined,
      data,
    };
      ...
      const response = await fetch(MONITOR_SERVER_URL, {
        ...
        body: JSON.stringify({
          ...
          data: {
            ...
            sinapse_agent: event.sinapse_agent,
            sinapse_story_id: event.sinapse_story_id,
          },
        }),
