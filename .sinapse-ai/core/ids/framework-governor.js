 ...
 *   const { IncrementalDecisionEngine } = require('.sinapse-ai/core/ids/incremental-decision-engine');
 *   const { RegistryUpdater } = require('.sinapse-ai/core/ids/registry-updater');
 *   const { FrameworkGovernor } = require('.sinapse-ai/core/ids/framework-governor');
 *
