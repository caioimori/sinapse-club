...
const LOCK_FILE = path.resolve(REPO_ROOT, '.sinapse-ai/data/.entity-registry.lock');
const BACKUP_DIR = path.resolve(REPO_ROOT, '.sinapse-ai/data/registry-backups');
const AUDIT_LOG_PATH = path.resolve(REPO_ROOT, '.sinapse-ai/data/registry-update-log.jsonl');
