...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.sinapse-ai/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.sinapse-ai/data/registry-backups/healing');
...
class RegistryHealer {
   ...
   * Integrates with SINAPSE NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          'Run \'sinapse ids:health --fix\' after resolving',
        ];
    }
  }
