...
This guide walks you through creating components in SINAPSE using the meta-agent's enhanced template system and interactive workflows.
...
1. **Check component examples**: `sinapse-ai/agents/examples/`
2. **Review templates**: `sinapse-ai/templates/`
...
Create custom templates in `sinapse-ai/templates/custom/`:
