...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between SINAPSE open-source and SINAPSE service implementations
...
SINAPSE has two deployment contexts:
...
|---------|----------|--------------|
| `@sinapse/core` | npm public | Open-source |
| `@sinapse/squad-etl` | npm public | Open-source |
| `@sinapse/squad-creator` | npm public | Open-source |
| `@sinapse/squad-mmos` | npm public | Open-source |
| `@sinapse/mcp-presets` | npm public | Open-source |
...
```yaml
**Template:**
- path: .sinapse-ai/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.sinapse-ai/templates/`
...
.sinapse-ai/checklists/{agent-id}-general-validation.md
```
...
- `.sinapse-ai/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .sinapse-ai/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.sinapse-ai/templates/`
...
- fallback: |
    ...
    1. Check .sinapse-ai/templates/ for generic version
...
**Agent Personas:**
- Defined in `.sinapse-ai/agents/{agent-id}.md`
...
- [ ] Update template paths (squads/ → .sinapse-ai/templates)
...
| **Templates** | .sinapse-ai/templates/ | squads/{squad}/ |
...
- [SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md](./SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v4.2 framework guide
