# SINAPSE Color Palette - Quick Reference
...
```javascript
// Import the SINAPSE color system
const { colors, status, headings } = require('./src/utils/sinapse-colors');

// Use in your code
console.log(headings.h1('Welcome to SINAPSE!'));
...
/* Use in your styles */
.button-primary {
  background: var(--sinapse-primary);
}
```
...
### Welcome Screen
```javascript
console.log(headings.h1('🎉 Welcome to SINAPSE v4.2 Installer!'));
...
- **Complete Guide:** [SINAPSE-COLOR-PALETTE-V2.1.md](./SINAPSE-COLOR-PALETTE-V2.1.md)
- **Color Module:** `src/utils/sinapse-colors.js`
