...
> _— Fundamento filosófico do SINAPSE_
...
- ✅ **npm Package Scoping** (@sinapse/core, @sinapse/squad-\*, @sinapse/mcp-presets)

**Referências Legadas:**

- `SINAPSE-LIVRO-DE-OURO.md` - Base v2.0.0 (Jan 2025)
- `SINAPSE-LIVRO-DE-OURO-V2.1.md` - Delta parcial
- `SINAPSE-LIVRO-DE-OURO-V2.1-SUMMARY.md` - Resumo de mudanças
...
│   │ npm: @sinapse/squad-*  │    │    │ npm: @sinapse/mcp-presets      │     │
│   └─────────────────────┘    │    └─────────────────────────────┘     │
│                              │                                         │
...
| **SINAPSE v4.2** | ✅ **Complete**          | ✅ **Clones (DNA Mental™)** ⭐ |

**Analogia:** Linux é open source, mas Red Hat Enterprise Linux adiciona suporte e otimizações. Ambos são Linux, mas o valor agregado varia. SINAPSE funciona igual.
...
- 📋 **Layer 3: USAGE GUIDE** - Como usar SINAPSE v4.2 no seu contexto
...
## Bem-vindo ao SINAPSE v4.2 - Vamos Encontrar Seu Caminho
...
## Essay 1: Por Que SINAPSE Existe
...
SINAPSE fornece **orquestração estruturada**:
...
|---------|----------|------------|---------|
| `@sinapse/core` | npm public | - | Commons Clause |
| `@sinapse/squad-etl` | npm public | @sinapse/core | MIT |
| `@sinapse/squad-creator` | npm public | @sinapse/core | MIT |
| `@sinapse/squad-mmos` | npm public | @sinapse/core | MIT |
| `@sinapse/mcp-presets` | npm public | - | Apache 2.0 |
...
$ sinapse stories create

# Execute a task
$ sinapse task develop-story --story=1.1
```
...
cd ../sinapse-squads && npm install && npm link @sinapse/core

# VS Code workspace
code sinapse-workspace.code-workspace
```
...
```bash
# Search for workers
$ sinapse workers search "json parse"
...
# Get worker details
$ sinapse workers info json-parser

# Use worker in task
$ sinapse workers use json-parser --task my-task
```
...
**Mantido Por:** SINAPSE Framework Team
