...
```yaml
# .sinapse-ai/data/archetype-vocabulary.yaml
...
```javascript
// .sinapse-ai/infrastructure/scripts/output-formatter.js
...
```javascript
// .sinapse-ai/infrastructure/scripts/validate-output-pattern.js
...
```markdown
<!-- .sinapse-ai/templates/task-execution-report.md -->
...
```markdown
<!-- .sinapse-ai/templates/agent-checklist-template.md -->
...
```yaml
# .sinapse-ai/workflows/{workflow-name}.yaml
