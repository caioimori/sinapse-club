# SINAPSE Task Format Specification V1.0
...
This document defines the UNIVERSAL format for SINAPSE Tasks, ensuring consistency, scalability, and reusability across workflows, executors, and teams.

---

## Task Format Overview

Every SINAPSE Task MUST follow this structure:
...
- callAgent:
    version: 1.0.0
    used_for: SINAPSE agent caller with retry logic
...
Use this checklist to validate any SINAPSE Task:
