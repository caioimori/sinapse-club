# SINAPSE Executor Decision Tree
...
This document defines HOW to choose the appropriate executor type (Agente, Worker, Humano, Clone) for any SINAPSE Task based on task characteristics, requirements, and constraints.
