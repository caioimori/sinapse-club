 ...
 *
 * Implements `sinapse workers list` CLI command.
...
function createListCommand() {
  ...
  list
    ...
    .addHelpText('after', `
Examples:
  $ sinapse workers list
  $ sinapse workers list --category=task
  $ sinapse workers list --format=table
  $ sinapse workers list --format=json --category=script
  $ sinapse workers list --page=2 --limit=10
  $ sinapse workers list --count
  $ sinapse workers list --verbose
