 ...
 *
 * Implements `sinapse workers search <query>` CLI command.
...
Examples:
  ...
  $ sinapse workers search "data transformation" --category=etl
  $ sinapse workers search "validation" --tags=schema,json
  $ sinapse workers search "api" --format=json --limit=5
  $ sinapse workers search "transform" --semantic
  $ sinapse workers search "convert" --keyword
`)
