...
Examples:
  ...
  $ sinapse workers search "data" --category=etl
  $ sinapse workers list --category=testing
  $ sinapse workers list --format=table --page=2
  $ sinapse workers info json-csv-transformer
  $ sinapse workers info architect-checklist --format=json
`);
