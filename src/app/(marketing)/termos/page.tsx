    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold mb-3 text-foreground">Termos de Uso</h1>
        ...
        <div className="max-w-none space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p className="text-foreground/80">
              Ao criar uma conta ou utilizar a plataforma <strong className="text-foreground">sinapse.club</strong>, você declara ter lido, compreendido e concordado com estes Termos de Uso e com nossa{" "}
              <Link href="/privacidade" className="text-foreground underline hover:opacity-70">
          ...
          {/* 3. Elegibilidade */}
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">3. Elegibilidade</h2>
            <p className="text-foreground/80">
              Para criar uma conta na sinapse.club, você deve:
            </p>
            <ul className="list-disc list-inside space-y-2 text-foreground/80 pl-2 mt-2">
          ...
          {/* 5. Proibições */}
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">5. Condutas Proibidas</h2>
            <p className="text-foreground/80 mb-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">6. Planos e Pagamentos</h2>
            <p className="text-foreground/80 mb-3">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-card rounded-lg border border-border">
                ...
                <p className="text-muted-foreground text-sm mt-1">Acesso limitado ao fórum e feed de conteúdo. Sem custo.</p>
              </div>
              <div className="p-4 bg-card rounded-lg border border-border">
                <p className="font-medium text-foreground">Plano Membro — a partir de R$ 29,90/mês</p>
                <p className="text-muted-foreground text-sm mt-1">Acesso completo à comunidade, conteúdos exclusivos, badge de membro e recursos premium. Disponível nos ciclos mensal (R$ 37,90), semestral (R$ 203,40) e anual (R$ 358,80). Cancelamento a qualquer momento, sem multa.</p>
              </div>
            </div>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">7. Propriedade Intelectual e Conteúdo do Usuário</h2>
            <p className="text-foreground/80 mb-3">
              <strong className="text-foreground">Seu conteúdo é seu.</strong> Você retém todos os direitos sobre o conteúdo que publica na plataforma (posts, comentários, imagens).
            </p>
            <p className="text-foreground/80">
          ...
          {/* 8. Exclusão de conta */}
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">8. Exclusão e Suspensão de Conta</h2>
            <p className="text-foreground/80 mb-3">
              <strong className="text-foreground">Exclusão pelo usuário:</strong> Você pode excluir sua conta a qualquer momento em{" "}
            ...
            <p className="text-foreground/80">
              <strong className="text-foreground">Suspensão pela plataforma:</strong> A sinapse.club se reserva o direito de suspender ou encerrar contas que violem estes Termos, sem aviso prévio em casos graves. Poderemos notificar o usuário por e-mail em casos de infração não grave antes de tomar qualquer ação.
            </p>
          </section>
          ...
          {/* 10. Lei aplicável */}
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">10. Lei Aplicável e Foro</h2>
            <p className="text-foreground/80">
              Estes Termos são regidos pelas leis da República Federativa do Brasil, incluindo a LGPD (Lei nº 13.709/2018) e o Código de Defesa do Consumidor (Lei nº 8.078/1990). Fica eleito o foro da Comarca de <strong className="text-foreground">São Paulo — SP</strong> para dirimir quaisquer controvérsias decorrentes destes Termos, com renúncia a qualquer outro, por mais privilegiado que seja.
            </p>
          </section>

          {/* 11. Alterações */}
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">11. Alterações nestes Termos</h2>
            <p className="text-foreground/80">
